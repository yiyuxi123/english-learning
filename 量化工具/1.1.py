...
# 假设这些是你的工厂和效率数据
factories = {
    '钻头A': {'output': {'A': 10}, 'input': {}},  # 每分钟产生10单位的资源A
    '钻头B': {'output': {'B': 8}, 'input': {}},   # 每分钟产生8单位的资源B
    '兵工厂': {'output': {'产品': 1}, 'input': {'A': 5, 'B': 3}}  # 每分钟产生1单位的产品，需要5单位的A和3单位的B
}
...
factory_var.set('兵工厂')  # default value
factory_menu = ttk.OptionMenu(frame, factory_var, '兵工厂', *factories.keys())
